...
use Fi1a\MySql\Handlers\Expressions\BetweenExpression;
use Fi1a\MySql\Handlers\Expressions\EqExpression;
use Fi1a\MySql\Handlers\Expressions\GtExpression;
use Fi1a\MySql\Handlers\Expressions\GteExpression;
use Fi1a\MySql\Handlers\Expressions\InExpression;
use Fi1a\MySql\Handlers\Expressions\IsExpression;
use Fi1a\MySql\Handlers\Expressions\IsNotExpression;
use Fi1a\MySql\Handlers\Expressions\LikeExpression;
use Fi1a\MySql\Handlers\Expressions\LtExpression;
use Fi1a\MySql\Handlers\Expressions\LteExpression;
use Fi1a\MySql\Handlers\Expressions\NotBetweenExpression;
use Fi1a\MySql\Handlers\Expressions\NotEqExpression;
use Fi1a\MySql\Handlers\Expressions\NotInExpression;
...
ExpressionRegistry::add('>=', GteExpression::class);
ExpressionRegistry::add('<', LtExpression::class);
ExpressionRegistry::add('<=', LteExpression::class);
...
ExpressionRegistry::add('between', BetweenExpression::class);
ExpressionRegistry::add('not between', NotBetweenExpression::class);
ExpressionRegistry::add('in', InExpression::class);
ExpressionRegistry::add('not in', NotInExpression::class);
